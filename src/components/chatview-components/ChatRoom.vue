<template>
  ...
  <DeleteChannelPasswordModal
    ...
    @submit="modalName = ''"
  />
  <SetChannelPrivateModal :isShow="modalName === '프라이빗 설정'" @close="modalName = ''" @submit="modalName = ''" />
  <UndoChannelPrivateModal :isShow="modalName === '프라이빗 해제'" @close="modalName = ''" @submit="modalName = ''" />
